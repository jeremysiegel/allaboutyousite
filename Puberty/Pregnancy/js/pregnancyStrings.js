export default class PregnancyStrings {
  constructor(get) {
    ...
    var definitions = {
      ...
      2: 'Second month:\n\nHere come your eyes, mouth, and ears. During pregnancy your food is going to come from a special organ called the placenta. It connects you to your mother through the umbilical cord (which goes into your belly button!)',
    ...
    var questions = [
      ...
      [
        "\nQ: How do twins happen?\n\nA: One way twins happen is if both ovaries release an egg at the same time. Both eggs can be fertilized and become fraternal twins. Sometimes one egg will be fertilized and then divide in two. That makes identical twins."
      ],
      [
