...
export default class Popup {
  constructor(scene, x, y, width, height, text) {
    this.screen = scene.add.rectangle(scene.cameras.main.width/2, scene.cameras.main.height/2, scene.cameras.main.width, scene.cameras.main.height, 0x000000, 0.4);
